...
class FormAndPreview extends Component {
  ...
  callMintMyNFTFromApp = (e) => {
    ...
    this.props.mintMyNFT(
      ...
      this.state.cryptoJoeName,
      this.state.cryptoJoePrice
    );
  };
      ...
      <div>
        <div className="card mt-1">
          <div className="card-body align-items-center d-flex justify-content-center">
            <h5>Color Your CryptoJoe As You Want It To be!</h5>
          </div>
        </div>
        <form onSubmit={this.callMintMyNFTFromApp} className="pt-4 mt-1">
          <div className="row">
            ...
            <div className="col-md-6 d-flex justify-content-center align-items-center">
              <CryptoJoeNFTImage colors={this.state.userSelectedColors[0]} />
            </div>
          </div>
          <div className="row">
            <div className="col-md-3">
            ...
            <div className="col-md-6">
              <div className="form-group">
                <label htmlFor="cryptoJoeName">Name</label>
                <input
                  required
                  type="text"
                  value={this.state.cryptoJoeName}
                  className="form-control"
                  placeholder="Enter Your CryptoJoe's Name"
                  onChange={(e) =>
                    this.setState({ cryptoJoeName: e.target.value })
                  }
                />
              </div>
              <div>
                ...
                <input
                  ...
                  name="price"
                  id="cryptoJoePrice"
                  value={this.state.cryptoJoePrice}
                  className="form-control"
                  placeholder="Enter Price In ETH"
                  onChange={(e) =>
                    this.setState({ cryptoJoePrice: e.target.value })
                  }
                />
              </div>
              <button
